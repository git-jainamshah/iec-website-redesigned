...
const searchIndex = [
    {
        ...
        path: '/about',
        category: 'Company',
        content: 'Indian Engineering Company established 1998 trusted partner heavy industrial motor generator repair ISO 9001 EASA certified 300000 sq ft facility Vadodara Gujarat India 20000 HP 13.8kV capacity 40 years industry experience',
    },
    {
        title: 'Leadership',
        path: '/leadership',
    ...
    },
    {
        ...
        category: 'Services',
        content: 'HV motor rewinding generator overhaul alternator repair DC motor servicing stator rotor repairs VPI rotor rebarring field coil rewinding 20000 HP 13.8kV complete repair rewinding services',
    },
    {
        title: 'Mechanical Repair',
        path: '/services#mechanical',
        category: 'Services',
        content: 'shaft fabrication shaft metalizing bearing housing repair commutator repair sleeve bearing re-babbitting spares fabrication mechanical rebuild',
    },
    {
        title: 'Pumps',
        path: '/services#pumps',
        category: 'Services',
        content: 'industrial pumps cryogenic submersible pumps Ebara 6.6kV impeller seal replacement comprehensive pump maintenance repair refurbishment',
    },
    {
        title: 'Spares Fabrication',
        path: '/services#spares',
        category: 'Services',
        content: 'rotor shafts end shield covers bearing housings heat exchangers cooling fans commutators in-house spares fabrication',
    },
    {
        title: 'Infrastructure',
        path: '/infrastructure',
        category: 'Facilities',
        content: 'HV coil manufacturing heating ovens mechanical workshop dynamic balancing testing control room crane system 300000 sq ft 75000 shop floor 300 ton crane 20MW no-load testing 5MW captive power state of the art facilities',
    },
    {

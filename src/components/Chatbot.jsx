...
const RESPONSES = [
    ...
    { keywords: ['contact', 'phone', 'call', 'reach', 'email'], response: "You can reach us at:\n📞 +91 98242 14839 (Mon–Sat, 9AM–5PM)\n📍 Plot No. 613, GIDC Estate, Ranoli, Gujarat\nOr visit our Contact page to submit an enquiry!" },
    { keywords: ['about', 'company', 'iec', 'history', 'who'], response: "Indian Engineering Company was established in 1998 in Ranoli, near Vadodara, Gujarat, backed by over 40 years of industry experience. We're EASA-certified (since 2014) and ISO 9001:2008 accredited, serving clients like ABB, BHEL, CG Power Group and Kirloskar Group." },
    ...
    { keywords: ['location', 'address', 'where', 'visit'], response: "We're located at Plot No. 613, GIDC Estate, Ranoli, Gujarat, with a second works at Raika on NH8. Our facilities span 300,000 sq ft total with a 75,000 sq ft shop floor. Want to schedule a facility tour?" },

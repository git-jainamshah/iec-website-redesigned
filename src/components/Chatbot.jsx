...
/* ──────────────────────────────────────────────
   ...
   ────────────────────────────────────────────── */
const RESPONSES = [
    { keywords: ['motor', 'generator', 'repair', 'rewind'], response: "We specialize in high-voltage motor & generator repair — rewinding, reconditioning, and overhauling for all major OEMs including ABB, TECO, Siemens, and BHEL. Want me to connect you with our engineering team?" },
    { keywords: ['pump', 'pumps'], response: "Our industrial pump repair services cover centrifugal, submersible, and vertical turbine pumps. We handle complete reconditioning with precision balancing and vibration analysis." },
    { keywords: ['spare', 'parts', 'component'], response: "We maintain comprehensive inventory of OEM and compatible spare parts for motors, generators, and pumps. Need a specific part? Share the model details and we'll check availability." },
    ...
    { keywords: ['about', 'company', 'iec', 'history', 'who'], response: "Indian Engineering Company has been a trusted name in industrial repairs since 1998. We're EASA-certified and ISO 9001 accredited, serving global clients like Tata Motors, Reliance, ABB, and BHEL." },
    { keywords: ['easa', 'certif', 'iso', 'quality'], response: "We're proud to be EASA Accredited — one of the few in India. We also hold ISO 9001:2015 certification, ensuring world-class quality standards in every repair we deliver." },
    { keywords: ['location', 'address', 'where', 'visit'], response: "We're located in Vatva GIDC, Ahmedabad, Gujarat — India's industrial heartland. Our facility spans over 30,000 sq ft with state-of-the-art testing bays. Want to schedule a facility tour?" },
    ...
    { keywords: ['infrastructure', 'facility', 'equipment', 'workshop'], response: "Our 30,000+ sq ft facility features VPI plants, dynamic balancing machines up to 10 tons, high-voltage test panels, and a dedicated clean room for precision work. Want to see our Infrastructure page?" },
    { keywords: ['service', 'what do you do', 'offer'], response: "We offer comprehensive industrial repair services:\n⚡ HV/LV Motor Rewinding & Repair\n⚙️ Generator Overhauling\n🔧 Industrial Pump Reconditioning\n🛠️ Spare Parts Supply\n\nWhat specific service interests you?" },
];
